<template>
  <div
    :class="{
      ...
      'bg-green-400 rounded-sm': isCompleted,
    }"
  >
    <div
        ...
        <input
          ...
          :class="{
            'bg-gray-300 placeholder-gray-500 text-gray-700 font-light focus:outline-none block w-full appearance-none leading-normal mr-3':
              !isCompleted,
            'bg-green-400 placeholder-gray-500 text-gray-700 font-light focus:outline-none block w-full appearance-none leading-normal mr-3':
              isCompleted,
          }"
